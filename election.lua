...
if gui == true then
	local file = io.open("new.txt", "w")
	if rgl > 0 then
		file:write("GOP: "..ric.." (+"..rgl..")\n")
	elseif rgl == 0 then
		file:write("GOP: "..ric.." (-"..")\n")
	else
		file:write("GOP: "..ric.." ("..rgl..")\n")
